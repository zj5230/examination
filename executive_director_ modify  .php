...
<td><input type='text' value='$row[1]' id='one'></td>
<td><input type='text' value='$row[2]' id='one'></td> 
<td><input type='button' value='保存' onClick='sa' /></td></tr></form>"  
?>
</tr>
</table>
...
$change="update personnel_management set nmae='{$row[1]}' where id='{$row[0]}'";
$change_result=mysql_query($change);
