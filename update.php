...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form")) {
  $updateSQL = sprintf("UPDATE personnel_management SET name=%s, `position`=%s WHERE id=%s",
                       GetSQLValueString($_POST['name'], "text"),
                       GetSQLValueString($_POST['position'], "text"),
                       GetSQLValueString($_POST['id'], "int"));

  mysql_select_db($database_examination, $examination);
  $Result1 = mysql_query($updateSQL, $examination) or die(mysql_error());

  $updateGoTo = "executive_director.php";
  if (isset($_SERVER['QUERY_STRING'])) {
